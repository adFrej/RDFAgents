...
class GraphGenerator:
    def __init__(self, *, total_triples: int = 25, mutation_chance: float = 0.1, uncover_outdated_chance: float = 0.3, triple_generator: Optional['TripleGenerator'] = None, seed=123):
